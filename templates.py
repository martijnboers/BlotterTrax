...
This is a placeholder text. This is what the bot should reply when a post is found to be a repost in violation of the rules of the sub. Please change it.
'''
